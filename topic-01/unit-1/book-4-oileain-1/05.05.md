...
This is a complete model for the above data structures:
...
We can recover the above data in Aurelia like this:
...
We keep the initial data untyped be declaring it as `any[]`. 